...
# === Generator Function for Downward Only ===
def generate_downward_trend_with_event_fluctuations(
    num_points,
    y_int,
    variability,
    trend_strengths,
...
# === Output Folder ===
OUTPUT_FOLDER = "data/Downward"

# === Generation Function ===
def generate_downward_variants():
    os.makedirs(OUTPUT_FOLDER, exist_ok=True)
    generator = generate_downward_trend_with_event_fluctuations

    for variant, config in CONFIG["Downward"].items():
        count = config["count"]
